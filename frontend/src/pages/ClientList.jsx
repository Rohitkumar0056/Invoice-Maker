                ...
                <div className="bg-gray-200 mt-2 p-2 flex-wrap">
                    <ul className='flex flex-col sm:flex-row justify-center items-center gap-4'>
                        <li className='pagination'>
                            <button className='bg-white hover:bg-green-200 font-bold  focus:outline-none text-sm text-green-500 py-2.5 px-5 text-center rounded-lg w-fit mx-auto' onClick={prePage}>Prev</button>
                        </li>
                        <li>
                            <div className='bg-white font-bold  focus:outline-none text-sm text-green-500 py-2.5 px-5 text-center rounded-lg w-fit mx-auto'>{currentPage}</div>
                        </li>
                        <li>
                            <button className='bg-white hover:bg-green-200 font-bold  focus:outline-none text-sm text-green-500 py-2.5 px-5 text-center rounded-lg w-fit mx-auto' onClick={nextPage}>Next</button>
                        </li>
                    </ul>
                </div>
            </div>
