...
const InvoiceDetails = () => {
    ...
    const sendPdf = (e) => {
        ...
        link: `http://localhost:4000/invoice/${invoice._id}`,
        })
        .then()
            .catch((error) => {
                console.log(error)
    ...
    return (
        <>
            ...
            {loading && <div className="bg-slate-100 m-4 p-2 shadow-2xl shadow-green-900 rounded-lg">
                <Skeleton className="rounded-lg mb-2 focus:outlinr-none border-2 border-dashed h-10" count={10} />
            </div>}
            ...
            {invoice && <div>
                <div className="bg-slate-100 m-4 flex flex-col justify-evenly rounded-lg gap-4 p-4">
                    ...
                    <div className="flex justify-around">
                        ...
                        <button onClick={createAndDownloadPdf} className="w-[40%] md:w-[25%] overflow-clip flex justify-center md:tracking-wider bg-[#0F959C] shadow-lg p-2 border-4 border-transparent active:border-black duration-100 active:text-black rounded-lg font-semibold text-white">
                            {download ?
                                <svg className="mr-3 h-5 w-5 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                ...
                <div className='bg-slate-100 m-4 shadow-2xl rounded-lg p-4 flex gap-4 flex-col'>
                    ...
                    <div className='mb-4 p-2 flex flex-col md:flex-row md:items-center gap-4'>
                        ...
                        <p className='bg-[#6DA5C0] shadow-lg w-[25%] text-white font-semibold p-2 rounded-lg'>{invoice.invoiceNumber}</p>
                    </div>
                    ...
                    <div className='bg-zinc-200 flex flex-col shadow-lg rounded-lg md:ml-[50%] p-4'>
                        ...
                        <div className='bg-zinc-200 rounded-lg flex flex-col p-4 mt-4'>
                            ...
                            <p className='bg-[#6DA5C0] text-white font-semibold rounded-lg p-2'>{invoice.notes}</p>
                        </div>
                    </div>
            </div>
            }
