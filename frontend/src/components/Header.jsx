...
import { register, login, logout } from "../actions/user.action";
    ...
    return (
        <>
            <div className="flex p-2 px-10 bg-white justify-between">
                {userInfo && <button className="md:hidden" onClick={() => setOpen((prev) => !prev)}>
                    {open ? "✖" :
                    <div>
                    ...
                    <div className={ open ?  "left-0 absolute top-[6%] h-screen w-[80%] sm:w-[50%] bg-white z-10 transition-all duration-300" : "-left-96 absolute top-[6%] h-screen w-[80%] sm:w-[35%] bg-white transition-all duration-300"}>
                        <ul className="flex flex-col items-center w-full text-base pt-10">
                            ...
                            <NavLink to="/customers" className='hover:bg-blue-200 w-full flex justify-center items-center py-4 rounded-lg'>
                                <li className='flex' >
                                    <svg className='hidden sm:flex' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill="#1A4D98" fillRule="evenodd" d="M9 13.4a6.006 6.006 0 00-6 6c0 .22.18.4.4.4h11.2a.4.4 0 00.4-.4 6.006 6.006 0 00-6-6zm0-8A3.8 3.8 0 119 13a3.8 3.8 0 010-7.6z" clipRule="evenodd"></path><path fill="#3299FE" fillRule="evenodd" d="M13.665 11.002L13.8 11a6.006 6.006 0 016 6 .4.4 0 01-.4.4h-3.483a7.225 7.225 0 00-3.65-4.415 5.01 5.01 0 001.399-1.983zm.136-.402a5.002 5.002 0 00-3.04-6.081A3.8 3.8 0 1113.8 10.6zm-3.605-5.008a3.802 3.802 0 012.408 4.816 3.802 3.802 0 00-2.408-4.816zm2.03 5.618zM9.002 13.4c.719.001 1.409.128 2.048.361a6.009 6.009 0 00-2.048-.361z" clipRule="evenodd"></path><rect x="7" y="11" width="4" height="3" rx="1" fill="#EBC2FF"></rect><rect x="7" y="15" width="4" height="3" rx="1" fill="#EBC2FF"></rect><rect x="13" y="11" width="4" height="3" rx="1" fill="#EBC2FF"></rect><rect x="13" y="15" width="4" height="3" rx="1" fill="#EBC2FF"></rect></svg>
                            ...
                            <li className="hover:bg-blue-200 w-full flex justify-center items-center py-4 rounded-lg">
                                <div className="flex gap-1 justify-center items-center transform transition-all hover:scale-110" onClick={logoutHandler}>
                ...
                {!userInfo && <div className="login flex space-x-1">
                    <button className="bg-indigo-500 hover:bg-indigo-600 font-bold focus:outline-none text-sm text-white px-3 text-center rounded-lg"
                    onClick={() => {
                        setShowModal(true)
                        setIsSignup(false)
                    }}>
            ...
            {showModal && <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center" id="wrapper" onMouseDown={onClose}>
                <div className="bg-white tracking-wider rounded-lg flex flex-col gap-4 p-4 px-6">
                    ...
                    <div className='flex bg-gray-100 rounded-lg border w-80 items-center'>
                        ...
                        <button className=' bg-purple-400 text-white p-2 m-2 font-bold rounded-lg py-0.5 h-7' onClick={()=> setShowPassword(!showPassword)}>
                    ...
                    {isSignUp && <div className='flex bg-gray-100 rounded-lg border w-80 items-center'>
                        ...
                        <button className=' bg-purple-400 text-white p-2 m-2 font-bold rounded-lg py-0.5 h-7' onClick={()=> setShowCPassword(!showCPassword)}>
                            {showCPassword ? "Hide" : "Show"}
                        </button>
                    </div>}

                    <button className='bg-indigo-500 hover:bg-indigo-600 font-bold focus:outline-none text-sm text-white py-2.5 px-5 text-center rounded-lg w-80' onClick={submitHandler}>
                        { isSignUp ? "Create Account" : "Log In"}
                    </button>
                    <hr className='my-2' />
                    <button className='bg-green-600 hover:bg-green-700 font-bold focus:outline-none text-sm text-white py-2.5 px-5 text-center rounded-lg w-fit mx-auto' onClick={() => {switchMode(); clear();}}>
